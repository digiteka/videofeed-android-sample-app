...
class VideoFeedFragmentActivity() : AppCompatActivity() {
	...
	companion object {
		...
		fun newInstance(activity: AppCompatActivity, mdtk: String, videoId: String?, adUnitPath: String?): Intent {
	...
	override fun onCreate(savedInstanceState: Bundle?) {
		...
		binding.fragmentContainerView.getFragment<VideoFeedFragment>().load(mdtk, videoId, adUnitPath)
	}
